                            ...
                            <div className="col-lg-5">
                                <div className="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div className="card-body">
                                        <div className="small mb-3 text-muted">Ingresa tu dirección de email te enviaremos un link para restablecer la contraseña.</div>
                                        <form>
                                    ...
                                    <div className="card-footer text-center py-3">
                                        <div className="small"><a>¿No tienes una cuenta? </a><Link to ="/Register">Registrese</Link></div>
                                    </div>
                                </div>
                            </div>
                        </div>
